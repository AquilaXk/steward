---
name: steward-work
description: Complete a multi-step authorized task that needs progress tracking or durable goals; skip trivial edits and review-only tasks that need no implementation.
---

# Work

Start with the requested outcome, existing context and a few useful acceptance conditions. Read only the relevant source and decisions. Keep a short dependency plan for broad work; do not build an exhaustive task tree before making progress.
...
Input: the authorized task and relevant source. Result: the requested deliverable, observed checks and any material remaining limitation.
